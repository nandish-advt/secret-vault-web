...
import { Card, Input, List, Empty, Spin, Alert, Button, Badge, Popconfirm, message, Space } from 'antd';
import { SearchOutlined, ReloadOutlined, KeyOutlined, CheckCircleFilled, DeleteOutlined } from '@ant-design/icons';
                    ...
                    description={
                      <div>
                        ...
                        <p style={{ fontSize: '12px', color: '#8c8c8c', marginTop: '8px' }}>
                          This will soft-delete the secret. It can be recovered within the retention period.
                        </p>
                      </div>
                    }
